    ...
    <section className="py-20 bg-black lg:py-32">
      <div className="container mx-auto px-4 flex flex-col md:flex-row items-center md:items-start gap-8 md:gap-12 lg:gap-16">
        ...
        <div className="w-full md:w-1/2 flex flex-col justify-center px-2 md:px-4">
          ...
          >
            De la Teoría a la Práctica en Equipo
          </motion.h2>
          <motion.p
            initial={{ opacity: 0, y: 20 }}
            animate={{ opacity: 1, y: 0 }}
          ...
          >
            En Folkode, llevamos el conocimiento del aula al siguiente nivel. Somos un equipo de estudiantes que cree en el poder de una software factory colaborativa para construir soluciones reales.
          </motion.p>
        </div>
      </div>
    </section>
